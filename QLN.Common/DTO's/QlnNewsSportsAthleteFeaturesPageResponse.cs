...
namespace QLN.Common.Infrastructure.DTO_s
{
    ...
    public class QlnNewsSportsAthleteFeatures
    {
        const string QueuePrefix = DrupalContentConstants.QlnNewsSportsAthleteFeatures;
    ...
    public class QlnNewsSportsAthleteFeaturesPageResponse
    {
        [JsonPropertyName(DrupalContentConstants.QlnNewsSportsAthleteFeatures)]
        public QlnNewsSportsAthleteFeatures News { get; set; }

        public static explicit operator GenericNewsPageResponse(QlnNewsSportsAthleteFeaturesPageResponse source)
        {
