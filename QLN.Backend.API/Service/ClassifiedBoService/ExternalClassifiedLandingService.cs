...
namespace QLN.Backend.API.Service.V2ClassifiedBoService
{
    public class ExternalClassifiedLandingService : IClassifiedBoLandingService
    {
        ...
        {
            //var mainCategory = await _dapr.GetStateAsync<ClassifiedsItems>(
            ...
            //    var l1Category = mainCategory.L1Category;
            //    var liCategoryId = mainCategory.L1CategoryId;
            //    var l2Category = mainCategory.L1Category;
            //    var l2CategoryId = mainCategory.L1CategoryId;
            //}
