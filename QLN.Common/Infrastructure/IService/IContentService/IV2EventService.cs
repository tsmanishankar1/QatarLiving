...
namespace QLN.Common.Infrastructure.IService.IContentService
{
    public interface IV2EventService
    {
        ...
        Task<string> StatusChange(string uid, Guid id, EventStatus status, CancellationToken cancellationToken = default);
        Task<IEnumerable<V2FeaturedEvents>> GetEventSummaries(CancellationToken cancellationToken = default); 
