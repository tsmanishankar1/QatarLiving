...
namespace QLN.Common.Infrastructure.IService.ICompanyService
{
    public interface ICompanyVerifiedService
    {
        ...
        Task<List<CompanyVerificationStatusDto>> VerificationStatus(string userId, VerticalType vertical, bool isVerified, CancellationToken cancellationToken = default);
