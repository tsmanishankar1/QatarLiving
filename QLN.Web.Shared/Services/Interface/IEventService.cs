namespace QLN.Web.Shared.Services.Interface
{
    public interface IEventService
    {
        ...
        Task<HttpResponseMessage?> GetAllEventsAsync(string? category_id = null, string? location_id = null,  string? from = null,string? to = null,int? page = 1, int? page_size = 20, string? order = "asc");
