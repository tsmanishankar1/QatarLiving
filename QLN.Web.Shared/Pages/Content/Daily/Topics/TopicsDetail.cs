...
{
    public class TopicDetailBase : ComponentBase
    {
        [Parameter]
    ...
    new() { Label = "Home & Living", Value = "home-and-living" }
        ...
        private async Task LoadContent()
        {
            ...
            TopicQueue1 = LandingContent?.ContentsDaily?.DailyTopics2?.Items ?? [];
            TopicQueue2 = LandingContent?.ContentsDaily?.DailyTopics4?.Items ?? [];
        }
