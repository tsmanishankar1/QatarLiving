...
public class ServiceLandingPageBase : QLComponentBase
{
    ...
    protected ServicesLandingPageItemType currentItemType;
    [Inject]
    ...
    {
        activeIndex = index;
        currentItemType = (ServicesLandingPageItemType)index;
        await LoadDataForCurrentTab();
    }
    ...
    protected async Task LoadDataForCurrentTab()
    {
        ...
        try
        {
            ...
            {
                case ServicesLandingPageItemType.FeaturedCategory:
                    currentItems = await LoadFeaturedCategories();
                    break;
                case ServicesLandingPageItemType.SeasonalPick:
                    currentItems = await LoadSeasonalPicks();
                    break;
                case ServicesLandingPageItemType.FeaturedServices:
    ...
    protected async Task SearchItems()
    {
        try
        {
            ...
            {
                ServicesLandingPageItemType.FeaturedCategory => await LoadFeaturedCategories(),
                ServicesLandingPageItemType.SeasonalPick => await LoadSeasonalPicks(),
                ServicesLandingPageItemType.FeaturedServices => await LoadFeaturedStores(),
...
public enum ServicesLandingPageItemType
{
    FeaturedCategory = 0,
    SeasonalPick = 1,
    FeaturedServices = 2
