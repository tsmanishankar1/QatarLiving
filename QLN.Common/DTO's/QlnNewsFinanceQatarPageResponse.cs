...
namespace QLN.Common.Infrastructure.DTO_s
{
    ...
    {
        const string QueuePrefix = DrupalContentConstants.QlnNewsFinanceQatar;
    ...
    public class QlnNewsFinanceQatarPageResponse
    {
        [JsonPropertyName(DrupalContentConstants.QlnNewsFinanceQatar)]
        public QlnNewsFinanceQatar News { get; set; }

        public static explicit operator GenericNewsPageResponse(QlnNewsFinanceQatarPageResponse source)
        {
