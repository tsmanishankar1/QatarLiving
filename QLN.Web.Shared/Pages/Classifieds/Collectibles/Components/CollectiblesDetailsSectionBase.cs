...
{
    public class CollectiblesDetailsSectionBase : ComponentBase
    {
        ...
        protected override void OnInitialized()
        {
            breadcrumbItems = new()
            {
                ...
                new BreadcrumbItem { Label = "Items", Url = "/qln/classifieds/items" },
                new BreadcrumbItem { Label = Item?.Title ?? "Details", Url = "/qln/classifieds/items/details", IsLast = true }
            };
        }
