...
namespace QLN.Common.Infrastructure.DTO_s
{
    ...
    public class QlnNewsSportsFootball
    {
        const string QueuePrefix = DrupalContentConstants.QlnNewsSportsFootball;
    ...
    public class QlnNewsSportsFootballPageResponse
    {
        [JsonPropertyName(DrupalContentConstants.QlnNewsSportsFootball)]
        public QlnNewsSportsFootball News { get; set; }

        public static explicit operator GenericNewsPageResponse(QlnNewsSportsFootballPageResponse source)
        {
