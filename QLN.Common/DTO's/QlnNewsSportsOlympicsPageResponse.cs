...
namespace QLN.Common.Infrastructure.DTO_s
{
    ...
    public class QlnNewsSportsOlympics
    {
        const string QueuePrefix = DrupalContentConstants.QlnNewsSportsOlympics;
    ...
    public class QlnNewsSportsOlympicsPageResponse
    {
        [JsonPropertyName(DrupalContentConstants.QlnNewsSportsOlympics)]
        public QlnNewsSportsOlympics News { get; set; }

        public static explicit operator GenericNewsPageResponse(QlnNewsSportsOlympicsPageResponse source)
        {
