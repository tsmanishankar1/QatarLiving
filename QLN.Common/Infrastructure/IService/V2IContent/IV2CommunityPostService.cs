...
namespace QLN.Common.Infrastructure.IService.V2IContent
{
    public interface IV2CommunityPostService
    {
        ...
        Task<CommunityCommentListResponse> GetCommentsByPostIdAsync(
              Guid postId,
              int? page = null,
              int? perPage = null,
        ...
        Task<bool> DislikeCommentAsync(Guid commentId, string userId, Guid communityPostId, CancellationToken ct = default);
