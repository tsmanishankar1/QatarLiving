...
namespace QLN.Common.Infrastructure.IService.IService
{
    public interface IServices
    {
        ...
        Task<string> CreateServiceAd(ServicesDto dto, CancellationToken cancellationToken = default);
        Task<string> UpdateServiceAd(ServicesDto dto, CancellationToken cancellationToken = default);
        ...
        Task<string> DeleteServiceAdById(Guid id, CancellationToken cancellationToken = default);
    }
}
