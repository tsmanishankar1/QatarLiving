...
namespace QLN.Common.Infrastructure.DTO_s
{
    ...
    public class QlnNewsSportsInternational
    {
        const string QueuePrefix = DrupalContentConstants.QlnNewsSportsInternational;
    ...
    public class QlnNewsSportsInternationalPageResponse
    {
        [JsonPropertyName(DrupalContentConstants.QlnNewsSportsInternational)]
        public QlnNewsSportsInternational News { get; set; }

        public static explicit operator GenericNewsPageResponse(QlnNewsSportsInternationalPageResponse source)
        {
